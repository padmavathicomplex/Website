    ...
    return (
        <div className="home-page">
            ...
            <section className="section bg-beige-medium">
                <div className="container">
                    <div className="text-center mb-xl">
                        <h2 className="heading-2">Transportation Services</h2>
                        <p className="text-large text-gray-dark">Convenient travel arrangements for your pilgrimage</p>
                    </div>

                    <div className="transport-card-wrapper">
                        <div className="transport-card">
                            <div className="transport-icon">🚗</div>
                            <div className="transport-info">
                                <h3 className="heading-3">Krishna Cars &amp; Travels</h3>
                                <p className="transport-desc">Cars &amp; vans available for local travel, temple visits, and outstation trips. Reliable and affordable transportation for devotees.</p>
                                <div className="transport-tags">
                                    <span className="transport-tag">🚗 Cars Available</span>
                                    <span className="transport-tag">🚐 Vans Available</span>
                                    <span className="transport-tag">🛕 Temple Visits</span>
                                </div>
                                <a href="tel:+919047842375" className="btn btn-primary btn-large transport-cta">
                                    📞 Call: +91 90478 42375
                                </a>
                            </div>
                        </div>
        ...
        .transport-card {
          ...
          max-width: 800px;
          width: 100%;
          border-left: 6px solid var(--color-maroon-primary);
        }
